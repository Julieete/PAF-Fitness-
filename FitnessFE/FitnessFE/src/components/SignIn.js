...
function SignIn() {
  ...
  src={asideImage} 
  alt="Aside" 
  className={`${styles.colContainerLeft} ${styles.leftBackground}`} 
  style={{width: '80%', height: 'auto', paddingTop: '10px', paddingBottom: '10px', marginTop: '40px',marginRight: '50px', marginBottom: '15px' }} 
/>
        ...
        {({
          ...
          >
            <Row className="mb-5 text-center">
              <h1 style={{ color: "black" , alignItems:"center"}}>Sign In</h1>
            </Row>
            <Row className="mb-3">
