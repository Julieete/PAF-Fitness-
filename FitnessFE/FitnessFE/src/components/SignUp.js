  ...
  return (
    <Container fluid className={styles.container}>
      ...
      <div className={styles.asideContainer}>
        <img src={asideImage} alt="Aside" className={`${styles.colContainerLeft} ${styles.leftBackground}`} style={{width: '80%', height: 'auto', paddingTop: '10px', paddingBottom: '10px', marginTop: '40px',marginLeft: '80px', marginBottom: '15px' }} />
      </div>
